...
%         rng(2020)
%         SAoptObjData2(m, n) = ObjectiveFunctionCrissCrossModelOne([weightValues1(m,1); weightValues2(m,1)], capacityCostValues(m,:), BlockingSamples, SAoptSolData(I,:,n,m), lambdaValues(m,:), muValues(m,:), alphaValues(m,1), NumberOfStations, BatchTime, DiscardedBatches, epsilonTilde, deltaTilde,MaxTime);
%     end
% end
% 
% for m = 1:NumberScenarios
...
%         rng(2020)
%         FFoptObjData2(m, n) = ObjectiveFunctionCrissCrossModelOne([weightValues1(m,1); weightValues2(m,1)], capacityCostValues(m,:), BlockingSamples, FFoptSolData(I,:,n,m), lambdaValues(m,:), muValues(m,:), alphaValues(m,1), NumberOfStations, BatchTime, DiscardedBatches, epsilonTilde, deltaTilde,MaxTime);
%     end
% end
% 
% for m = 1:NumberScenarios
...
%         rng(2020)
%         SurrOptObjData2(m, n) = ObjectiveFunctionCrissCrossModelOne([weightValues1(m,1); weightValues2(m,1)], capacityCostValues(m,:), BlockingSamples, SurrOptSolData(:,n,m)', lambdaValues(m,:), muValues(m,:), alphaValues(m,1), NumberOfStations, BatchTime, DiscardedBatches, epsilonTilde, deltaTilde,MaxTime);
%     end
% end
% 
% 
...
%         rng(2020)
%         BayesOptObjData2(m, n) = ObjectiveFunctionCrissCrossModelOne([weightValues1(m,1); weightValues2(m,1)], capacityCostValues(m,:), BlockingSamples, BayesOptSolData(:,n,m)', lambdaValues(m,:), muValues(m,:), alphaValues(m,1), NumberOfStations, BatchTime, DiscardedBatches, epsilonTilde, deltaTilde,MaxTime);
%     end
% end
% 
% 
...
%     for n = 1:NumberSamples
%         rng(2020)
%         InitialObjData(m, n) = ObjectiveFunctionCrissCrossModelOne([weightValues1(m,1); weightValues2(m,1)], capacityCostValues(m,:), BlockingSamples, FFoptSolData(1,:,n,m), lambdaValues(m,:), muValues(m,:), alphaValues(m,1), NumberOfStations, BatchTime, DiscardedBatches, epsilonTilde, deltaTilde,MaxTime);
%     end
% end
% 
...
%% PUT CODE FOR SOLUTION COMPARISON
