function [optimalC1,optimalC2,value] = ExactSolutionModelTwo(C1max, C2max, Weights, Mu, lambda, CapacityCost)
...
for C1 = 0:1:C1max
    for C2 = 0:1:C2max
       data(C1+1,C2+1) = ExactEvaluationModelTwo(C1, C2, Weights, Mu, lambda, CapacityCost);
