...
weightValues = NaN(NumberScenarios,2);
...
for m = 1:NumberScenarios
    ...
    for n = 1:NumberSamples
        ...
        opts = optimoptions('surrogateopt', 'MaxFunctionEvaluations', 100, 'Display', 'iter', 'InitialPoints', C0, 'PlotFcn', []);
