...
%         SAoptObjData(m, n) = ExactEvaluationModelTwo(SAoptSolData(m,1,n),SAoptSolData(m,2,n),weightValues(m,:)', muValues(m,:)', lambdaValues(m,1), capacityCostValues(m,:)');
%         BayesOptObjData(m, n) = ExactEvaluationModelTwo(BayesOptSolData(m,1,n),BayesOptSolData(m,2,n),weightValues(m,:)', muValues(m,:)', lambdaValues(m,1), capacityCostValues(m,:)');
%         SurrOptObjData(m, n) = ExactEvaluationModelTwo(SurrOptSolData(m,1,n),SurrOptSolData(m,2,n),weightValues(m,:)', muValues(m,:)', lambdaValues(m,1), capacityCostValues(m,:)');
%         InitialObjData(m, n) = ExactEvaluationModelTwo(InitialSolData(m,1,n),InitialSolData(m,2,n),weightValues(m,:)', muValues(m,:)', lambdaValues(m,1), capacityCostValues(m,:)');
%         FFoptObjData(m, n) = ExactEvaluationModelTwo(FFoptSolData(m,1,n),FFoptSolData(m,2,n),weightValues(m,:)', muValues(m,:)', lambdaValues(m,1), capacityCostValues(m,:)');
%     end
%     m/NumberScenarios
% end
% 
