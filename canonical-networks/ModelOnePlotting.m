...
%         rng(2020)
%         FFoptObjData2(m, n) = ObjectiveFunctionCanonicalModelOne(weightValues(m,:)', BlockingSamples, FFoptSolData(I,:,n,m), muValues(m,:),  lambdaValues(m,:), capacityCostValues(m,:), BatchTime, BurnInTime, epsilonTilde, deltaTilde,MaxTime,m);
%     end
% end
% 
% for m = 1:NumberScenarios
...
%         rng(2020)
%         SurrOptObjData2(m, n) = ObjectiveFunctionCanonicalModelOne(weightValues(m,:)', BlockingSamples, SurrOptSolData(:,n,m)', muValues(m,:),  lambdaValues(m,:), capacityCostValues(m,:), BatchTime, BurnInTime, epsilonTilde, deltaTilde,MaxTime,m);
%     end
% end
% 
% for m = 1:NumberScenarios
...
%         rng(2020)
%         BayesOptObjData2(m, n) =ObjectiveFunctionCanonicalModelOne(weightValues(m,:)', BlockingSamples, BayesOptSolData(:,n,m)', muValues(m,:),  lambdaValues(m,:), capacityCostValues(m,:), BatchTime, BurnInTime, epsilonTilde, deltaTilde,MaxTime,m);
%     end
% end
% 
% for m = 1:NumberScenarios
%     for n = 1:NumberSamples
%         rng(2020)
%         InitialObjData(m, n) = ObjectiveFunctionCanonicalModelOne(weightValues(m,:)', BlockingSamples, FFoptSolData(1,:,n,m), muValues(m,:),  lambdaValues(m,:), capacityCostValues(m,:), BatchTime, BurnInTime, epsilonTilde, deltaTilde,MaxTime,m);
%     end
% end
% 
